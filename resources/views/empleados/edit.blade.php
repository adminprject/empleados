		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header text-align-center">
					<h4 style="float:left;">Formulario de Actualizacion</h4>
				...
				<div class="card-body">
					...
					@endif
					<form method="post" action="{{ url('empleados/update') }}/{{ $empleado->id }}">
					@csrf
						<div class="container">
							<div class="mb-3 row">
						    ...
						    <div class="mb-3 row" style="margin-top: 1rem;">
						    	...
						    	<div class="col-sm-10">
									...
									<div class="form-check">
										@if($empleado->sexo == 'F')
									  		<input class="form-check-input" type="radio" name="sexo" id="sexo2" value="F" required checked>
									  	@else
						    	...
						    	<div class="col-sm-10">
							      	<div class="form-check">
							      		@if($empleado->boletin == 1)
									  		<input class="form-check-input" type="checkbox" name="boletin" id="boletin" value="1" checked>
									  	@else
						    ...
						    <div class="mb-3 row" style="margin-top: 1rem;">
						    	...
						    	<input class="btn btn-success" style="width: 10rem; margin-left: 1rem;" type="submit" value="Actualizar">
						    </div>
					    </div>
					  </div>
					</form>
